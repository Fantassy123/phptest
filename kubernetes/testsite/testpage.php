...
/*resttest*/
  ...
  if($focus==1)
    {
      ...
      {
        $url="http://10.43.166.250:5051/valideer/" . $_POST['txt_naam'] . "/" . $_POST['txt_password'];
  ...
  if($focus==2)
   {
     $url="http://10.43.199.202:5052/hoofdstad/" . $_POST['txt_land'];
...
<body>
   <h1>Kubernetes Testapplicatie voor DEVOPS, VERSIE-01</h1>
